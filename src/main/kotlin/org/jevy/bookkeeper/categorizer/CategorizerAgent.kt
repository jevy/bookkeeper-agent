package org.jevy.bookkeeper.categorizer
...
import org.jevy.bookkeeper.categorizer.tools.SheetLookupTool
import org.jevy.bookkeeper.categorizer.tools.WebSearchTool
...
import org.jevy.bookkeeper.metrics.OpenRouterMetricsInterceptor
...
class CategorizerAgent(
    ...
    private val categorizedCounter = meterRegistry.counter("bookkeeper.categorizer.transactions", "result", "categorized")
    private val unknownCounter = meterRegistry.counter("bookkeeper.categorizer.transactions", "result", "unknown")
    private val failedCounter = meterRegistry.counter("bookkeeper.categorizer.failed")
    private val durationTimer = meterRegistry.timer("bookkeeper.categorizer.duration")
